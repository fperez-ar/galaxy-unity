public static class Filenames {
	...
	public const string PlyTroops = "troops.r";

	public const string PlyResourcesDir = "resources";
	public const string PlyResourcesFile = "resources.r";

	public const string PlyGenesDir = "genes";
	public const string PlyGenes = "genes.r";
