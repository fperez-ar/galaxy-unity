...
public class PlanetEditor : Editor
{
	...
	static bool[] gfold = new bool[2]{true, false};
	static bool[] rfold = new bool[2]{true, false};
	static bool[] tfold = new bool[2]{true, false};
	...
	public override void OnInspectorGUI ()
	{
		...
		if ( GUILayout.Button("Force init civilization")) {
